...
{'cache_infile': True,
 ...
 'sources_status': {'build/src.macosx-14.5-x86_64-3.11/numpy/core/src/_simd/_simd.dispatch.c': (True,
                                                                                                []),
                    'build/src.macosx-14.5-x86_64-3.11/numpy/core/src/multiarray/argfunc.dispatch.c': (True,
                                                                                                       []),
                    'build/src.macosx-14.5-x86_64-3.11/numpy/core/src/umath/loops_arithm_fp.dispatch.c': (True,
                                                                                                          []),
                    'build/src.macosx-14.5-x86_64-3.11/numpy/core/src/umath/loops_arithmetic.dispatch.c': (True,
                                                                                                           []),
                    'build/src.macosx-14.5-x86_64-3.11/numpy/core/src/umath/loops_comparison.dispatch.c': (True,
                                                                                                           []),
                    'build/src.macosx-14.5-x86_64-3.11/numpy/core/src/umath/loops_exponent_log.dispatch.c': (True,
                                                                                                             []),
                    'build/src.macosx-14.5-x86_64-3.11/numpy/core/src/umath/loops_hyperbolic.dispatch.c': (True,
                                                                                                           []),
                    'build/src.macosx-14.5-x86_64-3.11/numpy/core/src/umath/loops_minmax.dispatch.c': (True,
                                                                                                       []),
                    'build/src.macosx-14.5-x86_64-3.11/numpy/core/src/umath/loops_modulo.dispatch.c': (True,
                                                                                                       []),
                    'build/src.macosx-14.5-x86_64-3.11/numpy/core/src/umath/loops_trigonometric.dispatch.c': (True,
                                                                                                              []),
                    'build/src.macosx-14.5-x86_64-3.11/numpy/core/src/umath/loops_umath_fp.dispatch.c': (True,
                                                                                                         []),
                    'build/src.macosx-14.5-x86_64-3.11/numpy/core/src/umath/loops_unary_fp.dispatch.c': (True,
                                                                                                         []),
                    'numpy/core/src/npysort/x86-qsort.dispatch.cpp': (False,
                                                                      []),
